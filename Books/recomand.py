...
class Recommender:
    def __init__(self,data = None, k=1, metric='pearson', n=5):
        ...
        data   
        k      KNN K
        metric measure distance's metric
        n      num_reaturn recommand item
        """
        self.k = k
        self.n = n
        self.username2id = {}
        ...
        if self.metric == 'pearson':
            ...
            self.fn = self.l2_distance
        
        elif self.metric == "cos":
            self.fn = self.cos_distance
        if data:
...
new_users = {"Angelica": {"Blues Traveler": 3.5, "Broken Bells": 2.0,
